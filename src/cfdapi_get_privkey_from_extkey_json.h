 ...
 */
#ifndef CFD_JS_SRC_CFDAPI_GET_PRIVKEY_FROM_EXTKEY_JSON_H_
#define CFD_JS_SRC_CFDAPI_GET_PRIVKEY_FROM_EXTKEY_JSON_H_
...
#endif  // CFD_JS_SRC_CFDAPI_GET_PRIVKEY_FROM_EXTKEY_JSON_H_
