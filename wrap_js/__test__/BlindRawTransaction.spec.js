...
const convertUnblindTransaction1 = (json_string) => {
  return checkFunction(json_string, blindingKeys1, null);
};

const convertUnblindTransaction2 = (json_string) => {
  return checkFunction(json_string, blindingKeys2, null);
};
...
const convertUnblindTransaction3 = (json_string) => {
  return checkFunction(json_string, blindingKeys3, issuanceList1);
};
