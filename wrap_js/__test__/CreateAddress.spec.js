...
const testCase = [
  ...
  TestHelper.createBitcoinTestCase(
    ...
    CreateAddress,
    ["{\"scriptHex\":\"\", \"pubkeyHex\":\"0279BE667EF9DCBBAC55A06295CE870B07029BFCDB2DCE28D959F2815B16F81798\", \"network\":\"mainnet\", \"hashType\":\"p2sh-p2wpkh\"}"],
  ...
  TestHelper.createBitcoinTestCase(
    ...
    CreateAddress,
    ["{\"scriptHex\":\"\", \"pubkeyHex\":\"0279BE667EF9DCBBAC55A06295CE870B07029BFCDB2DCE28D959F2815B16F81798\", \"network\":\"testnet\", \"hashType\":\"p2sh-p2wpkh\"}"],
  ...
  TestHelper.createBitcoinTestCase(
    ...
    CreateAddress,
    ["{\"scriptHex\":\"210279be667ef9dcbbac55a06295ce870b07029bfcdb2dce28d959f2815b16f81798ac\", \"pubkeyHex\":\"\", \"network\":\"mainnet\", \"hashType\":\"p2sh-p2wsh\"}"],
  ...
  TestHelper.createBitcoinTestCase(
    ...
    CreateAddress,
    ["{\"scriptHex\":\"210279be667ef9dcbbac55a06295ce870b07029bfcdb2dce28d959f2815b16f81798ac\", \"pubkeyHex\":\"\", \"network\":\"testnet\", \"hashType\":\"p2sh-p2wsh\"}"],
  ...
  TestHelper.createElementsTestCase(
    ...
    CreateAddress,
    ["{\"isElements\":true,\"scriptHex\":\"\", \"pubkeyHex\":\"02054feb47f9c5142beb9ec06cb7c7d2e2a1be1f58e1fba3aa32ad6c2bbc53f6ce\", \"network\":\"liquidv1\", \"hashType\":\"p2pkh\"}"],
  ...
  TestHelper.createElementsTestCase(
    ...
    CreateAddress,
    ["{\"isElements\":true,\"scriptHex\":\"\", \"pubkeyHex\":\"0221a8c3759f94ee780086ef2e180401ab57e65eb37a8ad4048c9304a3aa430d46\", \"network\":\"regtest\", \"hashType\":\"p2pkh\"}"],
  ...
  TestHelper.createElementsTestCase(
    ...
    CreateAddress,
    ["{\"isElements\":true,\"scriptHex\":\"5221026922ebe722bad2f73f1f2f4f8be39a8215bc5d68d2f12b655c9ed7290b419461210359d250d32ab5e30246d3a15fe9ec202613b3c2354133184e1aada4f5ff570b1d52ae\", \"pubkeyHex\":\"\", \"network\":\"liquidv1\", \"hashType\":\"p2sh\"}"],
  ...
  TestHelper.createElementsTestCase(
    ...
    CreateAddress,
    ["{\"isElements\":true,\"scriptHex\":\"5221024c055f6ed23a35f72ee508c3ad51b131686340ef54ea56357b9a025ffb6b93002103c6c56c7b12b4d224f036fb47987b579e871d3f4919a6801cf9df56615ff0f22152ae\", \"pubkeyHex\":\"\", \"network\":\"regtest\", \"hashType\":\"p2sh\"}"],
  ...
  TestHelper.createElementsTestCase(
    ...
    CreateAddress,
    ["{\"isElements\":true,\"scriptHex\":\"\", \"pubkeyHex\":\"02054feb47f9c5142beb9ec06cb7c7d2e2a1be1f58e1fba3aa32ad6c2bbc53f6ce\", \"network\":\"liquidv1\", \"hashType\":\"p2sh-p2wpkh\"}"],
  ...
  TestHelper.createElementsTestCase(
    ...
    CreateAddress,
    ["{\"isElements\":true,\"scriptHex\":\"\", \"pubkeyHex\":\"02494f889a875d1ccdab8c34d40346f2661e7e2f7c31088c2fdd1ffc9ede838faa\", \"network\":\"regtest\", \"hashType\":\"p2sh-p2wpkh\"}"],
  ...
  TestHelper.createElementsTestCase(
    ...
    CreateAddress,
    ["{\"isElements\":true,\"scriptHex\":\"5221026922ebe722bad2f73f1f2f4f8be39a8215bc5d68d2f12b655c9ed7290b419461210359d250d32ab5e30246d3a15fe9ec202613b3c2354133184e1aada4f5ff570b1d52ae\", \"pubkeyHex\":\"\", \"network\":\"liquidv1\", \"hashType\":\"p2sh-p2wsh\"}"],
  ...
  TestHelper.createElementsTestCase(
    ...
    CreateAddress,
    ["{\"isElements\":true,\"scriptHex\":\"522103789ed0bb717d88f7d321a368d905e7430207ebbd82bd342cf11ae157a7ace5fd2103dbc6764b8884a92e871274b87583e6d5c2a58819473e17e107ef3f6aa5a6162652ae\", \"pubkeyHex\":\"\", \"network\":\"regtest\", \"hashType\":\"p2sh-p2wsh\"}"],
  ...
  TestHelper.createElementsTestCase(
    ...
    CreateAddress,
    ["{\"isElements\":true,\"scriptHex\":\"\", \"pubkeyHex\":\"02054feb47f9c5142beb9ec06cb7c7d2e2a1be1f58e1fba3aa32ad6c2bbc53f6ce\", \"network\":\"liquidv1\", \"hashType\":\"p2wpkh\"}"],
  ...
  TestHelper.createElementsTestCase(
    ...
    CreateAddress,
    ["{\"isElements\":true,\"scriptHex\":\"\", \"pubkeyHex\":\"02086983d61829536858913ead064797b71c598628e03d2d04dadcd151715a7552\", \"network\":\"regtest\", \"hashType\":\"p2wpkh\"}"],
  ...
  TestHelper.createElementsTestCase(
    ...
    CreateAddress,
    ["{\"isElements\":true,\"scriptHex\":\"5221026922ebe722bad2f73f1f2f4f8be39a8215bc5d68d2f12b655c9ed7290b419461210359d250d32ab5e30246d3a15fe9ec202613b3c2354133184e1aada4f5ff570b1d52ae\", \"pubkeyHex\":\"\", \"network\":\"liquidv1\", \"hashType\":\"p2wsh\"}"],
  ...
  TestHelper.createElementsTestCase(
    ...
    CreateAddress,
    ["{\"isElements\":true,\"scriptHex\":\"522103789ed0bb717d88f7d321a368d905e7430207ebbd82bd342cf11ae157a7ace5fd2103dbc6764b8884a92e871274b87583e6d5c2a58819473e17e107ef3f6aa5a6162652ae\", \"pubkeyHex\":\"\", \"network\":\"regtest\", \"hashType\":\"p2wsh\"}"],
...
const errorCase = [
  ...
  TestHelper.createElementsTestCase(
    "CreateAddress Error(network is invalid)",
    CreateAddress,
    ["{\"isElements\":true,\"scriptHex\":\"\", \"pubkeyHex\":\"025476c2e83188368da1ff3e292e7acafcdb3566bb0ad253f62fc70f07aeee6357\", \"network\":\"mainnet\", \"hashType\":\"p2wpkh\"}"],
  ...
  TestHelper.createElementsTestCase(
    "CreateAddress Error(hashtype is invalid)",
    CreateAddress,
    ["{\"isElements\":true,\"scriptHex\":\"\", \"pubkeyHex\":\"025476c2e83188368da1ff3e292e7acafcdb3566bb0ad253f62fc70f07aeee6357\", \"network\":\"liquidv1\", \"hashType\":\"p2pk\"}"],
    "{\"error\":{\"code\":1,\"type\":\"illegal_argument\",\"message\":\"Invalid address_type passed. address_type must be \\\"p2pkh\\\", \\\"p2sh\\\", \\\"p2wpkh\\\", \\\"p2wsh\\\", \\\"p2sh-p2wpkh\\\", or \\\"p2sh-p2wsh\\\".\"}}"
  ),
  TestHelper.createElementsTestCase(
    "CreateAddress Error(scriptHex is invalid)",
    CreateAddress,
    ["{\"isElements\":true,\"scriptHex\":\"0254\", \"pubkeyHex\":\"\", \"network\":\"regtest\", \"hashType\":\"p2sh\"}"],
    "{\"error\":{\"code\":1,\"type\":\"illegal_argument\",\"message\":\"buffer is incorrect size.\"}}"
  ),
  TestHelper.createElementsTestCase(
    "CreateAddress Error(pubkeyHex is invalid)",
    CreateAddress,
    ["{\"isElements\":true,\"scriptHex\":\"\", \"pubkeyHex\":\"0254\", \"network\":\"regtest\", \"hashType\":\"p2pkh\"}"],
    "{\"error\":{\"code\":1,\"type\":\"illegal_argument\",\"message\":\"Invalid Pubkey data.\"}}"
  ),
  TestHelper.createElementsTestCase(
    "CreateAddress Error(scriptHex is none)",
    CreateAddress,
    ["{\"isElements\":true,\"scriptHex\":\"\", \"pubkeyHex\":\"\", \"network\":\"regtest\", \"hashType\":\"p2sh\"}"],
    "{\"error\":{\"code\":1,\"type\":\"illegal_argument\",\"message\":\"script_hex is empty.\"}}"
  ),
  TestHelper.createElementsTestCase(
    "CreateAddress Error(pubkeyHex is none)",
    CreateAddress,
    ["{\"isElements\":true,\"scriptHex\":\"\", \"pubkeyHex\":\"\", \"network\":\"regtest\", \"hashType\":\"p2pkh\"}"],
    "{\"error\":{\"code\":1,\"type\":\"illegal_argument\",\"message\":\"pubkey_hex is empty.\"}}"
  ),
  TestHelper.createElementsTestCase(
    "CreateAddress Error(pubkeyHex is longer)",
    CreateAddress,
    ["{\"isElements\":true,\"scriptHex\":\"\", \"pubkeyHex\":\"0250863ad64a87ae8a2fe83c1af1a8403cb53f53e486d8511dad8a04887e5b23520250863ad64a87ae8a2fe83c1af1a8403cb53f53e486d8511dad8a04887e5b2352\", \"network\":\"regtest\", \"hashType\":\"p2pkh\"}"],
    "{\"error\":{\"code\":1,\"type\":\"illegal_argument\",\"message\":\"Invalid Pubkey data.\"}}"
  )
]
