...
const testCase = [
  TestHelper.createBitcoinTestCase(
    ...
    GetWitnessStackNum,
    ["{\"tx\":\"02000000014cdeada737db97af334f0fa4e87432d6068759eea65a3067d1f14a979e5a9dea0000000000ffffffff0101000000000000002200201863143c14c5166804bd19203356da136c985678cd4d27a1b8c632960490326200000000\",\"txid\":\"ea9d5a9e974af1d167305aa6ee598706d63274e8a40f4f33af97db37a7adde4c\",\"vout\":0}"],
    "{\"count\":0}"
  ),
  TestHelper.createBitcoinTestCase(
    "GetWitnessStackNum stack count-2",
    GetWitnessStackNum,
    ["{\"tx\":\"020000000001014cdeada737db97af334f0fa4e87432d6068759eea65a3067d1f14a979e5a9dea0000000000ffffffff0101000000000000002200201863143c14c5166804bd19203356da136c985678cd4d27a1b8c6329604903262020411111111042222222200000000\",\"txid\":\"ea9d5a9e974af1d167305aa6ee598706d63274e8a40f4f33af97db37a7adde4c\",\"vout\":0}"],
    "{\"count\":2}"
  ),
]
...
const errorCase = [
  TestHelper.createBitcoinTestCase(
    ...
    GetWitnessStackNum,
    ["{\"tx\":\"\",\"txid\":\"ea9d5a9e974af1d167305aa6ee598706d63274e8a40f4f33af97db37a7adde4c\",\"vout\":0,\"witnessStack\":{\"hex\":\"11111111\",\"type\":\"binary\",\"derEncode\":false,\"sighashType\":\"all\"}}"],
    "{\"error\":{\"code\":1,\"type\":\"illegal_argument\",\"message\":\"Invalid hex string. empty data.\"}}"
  ),
  TestHelper.createBitcoinTestCase(
    "GetWitnessStackNum invalid hex string(3 chars)",
    GetWitnessStackNum,
    ["{\"tx\":\"000\",\"txid\":\"ea9d5a9e974af1d167305aa6ee598706d63274e8a40f4f33af97db37a7adde4c\",\"vout\":0,\"witnessStack\":{\"hex\":\"11111111\",\"type\":\"binary\",\"derEncode\":false,\"sighashType\":\"all\"}}"],
    "{\"error\":{\"code\":1,\"type\":\"illegal_argument\",\"message\":\"hex to byte convert error.\"}}"
  ),
  TestHelper.createBitcoinTestCase(
    "GetWitnessStackNum empty txid string",
    GetWitnessStackNum,
    ["{\"tx\":\"02000000014cdeada737db97af334f0fa4e87432d6068759eea65a3067d1f14a979e5a9dea0000000000ffffffff0101000000000000002200201863143c14c5166804bd19203356da136c985678cd4d27a1b8c632960490326200000000\",\"txid\":\"\",\"vout\":0,\"witnessStack\":{\"hex\":\"11111111\",\"type\":\"binary\",\"derEncode\":false,\"sighashType\":\"all\"}}"],
    "{\"error\":{\"code\":1,\"type\":\"illegal_argument\",\"message\":\"Txid size Invalid.\"}}"
  ),
  TestHelper.createBitcoinTestCase(
    "GetWitnessStackNum invalid txid string (20 chars)",
    GetWitnessStackNum,
    ["{\"tx\":\"02000000014cdeada737db97af334f0fa4e87432d6068759eea65a3067d1f14a979e5a9dea0000000000ffffffff0101000000000000002200201863143c14c5166804bd19203356da136c985678cd4d27a1b8c632960490326200000000\",\"txid\":\"ea9d5a9e974af1d16730\",\"vout\":0,\"witnessStack\":{\"hex\":\"11111111\",\"type\":\"binary\",\"derEncode\":false,\"sighashType\":\"all\"}}"],
    "{\"error\":{\"code\":1,\"type\":\"illegal_argument\",\"message\":\"Txid size Invalid.\"}}"
  ),
  TestHelper.createBitcoinTestCase(
    "GetWitnessStackNum txid not found",
    GetWitnessStackNum,
    ["{\"tx\":\"02000000014cdeada737db97af334f0fa4e87432d6068759eea65a3067d1f14a979e5a9dea0000000000ffffffff0101000000000000002200201863143c14c5166804bd19203356da136c985678cd4d27a1b8c632960490326200000000\",\"txid\":\"ea9d5a9e974af1d167305aa6ee598706d63274e8a40f4f33af97db37a7adde4d\",\"vout\":0,\"witnessStack\":{\"hex\":\"11111111\",\"type\":\"binary\",\"derEncode\":false,\"sighashType\":\"all\"}}"],
    "{\"error\":{\"code\":1,\"type\":\"illegal_argument\",\"message\":\"Txid is not found.\"}}"
  ),
  TestHelper.createBitcoinTestCase(
    "GetWitnessStackNum append signature to invalid txin(vout: -1)",
    GetWitnessStackNum,
    ["{\"tx\":\"02000000014cdeada737db97af334f0fa4e87432d6068759eea65a3067d1f14a979e5a9dea0000000000ffffffff0101000000000000002200201863143c14c5166804bd19203356da136c985678cd4d27a1b8c632960490326200000000\",\"txid\":\"ea9d5a9e974af1d167305aa6ee598706d63274e8a40f4f33af97db37a7adde4c\",\"vout\":-1,\"witnessStack\":{\"hex\":\"11111111\",\"type\":\"binary\",\"derEncode\":false,\"sighashType\":\"all\"}}"],
...
const errorCaseElements = [
  TestHelper.createElementsTestCase(
    "GetWitnessStackNum empty hex string",
    GetWitnessStackNum,
    ["{\"tx\":\"\",\"isElements\":true,\"txid\":\"ea9d5a9e974af1d167305aa6ee598706d63274e8a40f4f33af97db37a7adde4c\",\"vout\":0,\"witnessStack\":{\"hex\":\"11111111\",\"type\":\"binary\",\"derEncode\":false,\"sighashType\":\"all\"}}"],
    "{\"error\":{\"code\":1,\"type\":\"illegal_argument\",\"message\":\"Invalid hex string. empty data.\"}}"
  ),
  TestHelper.createElementsTestCase(
    "GetWitnessStackNum invalid hex string(3 chars)",
    GetWitnessStackNum,
    ["{\"tx\":\"000\",\"isElements\":true,\"txid\":\"ea9d5a9e974af1d167305aa6ee598706d63274e8a40f4f33af97db37a7adde4c\",\"vout\":0,\"witnessStack\":{\"hex\":\"11111111\",\"type\":\"binary\",\"derEncode\":false,\"sighashType\":\"all\"}}"],
    "{\"error\":{\"code\":1,\"type\":\"illegal_argument\",\"message\":\"transaction data invalid.\"}}"
  ),
  TestHelper.createElementsTestCase(
    "GetWitnessStackNum empty txid string",
    GetWitnessStackNum,
    ["{\"tx\":\"\",\"isElements\":true,\"txid\":\"\",\"vout\":0,\"witnessStack\":{\"hex\":\"11111111\",\"type\":\"binary\",\"derEncode\":false,\"sighashType\":\"all\"}}"],
    "{\"error\":{\"code\":1,\"type\":\"illegal_argument\",\"message\":\"Txid size Invalid.\"}}"
  ),
  TestHelper.createElementsTestCase(
    "GetWitnessStackNum invalid txid string (20 chars)",
    GetWitnessStackNum,
    ["{\"tx\":\"\",\"isElements\":true,\"txid\":\"ea9d5a9e974af1d16730\",\"vout\":0,\"witnessStack\":{\"hex\":\"11111111\",\"type\":\"binary\",\"derEncode\":false,\"sighashType\":\"all\"}}"],
    "{\"error\":{\"code\":1,\"type\":\"illegal_argument\",\"message\":\"Txid size Invalid.\"}}"
  ),
  TestHelper.createElementsTestCase(
    "GetWitnessStackNum txid not found",
    GetWitnessStackNum,
    ["{\"tx\":\"\",\"isElements\":true,\"txid\":\"ea9d5a9e974af1d167305aa6ee598706d63274e8a40f4f33af97db37a7adde4d\",\"vout\":0,\"witnessStack\":{\"hex\":\"11111111\",\"type\":\"binary\",\"derEncode\":false,\"sighashType\":\"all\"}}"],
    "{\"error\":{\"code\":1,\"type\":\"illegal_argument\",\"message\":\"Txid is not found.\"}}"
  ),
  TestHelper.createElementsTestCase(
    "GetWitnessStackNum append signature to invalid txin(vout: -1)",
