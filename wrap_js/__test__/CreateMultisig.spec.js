...
const testCase = [
  TestHelper.createBitcoinTestCase(
    ...
    CreateMultisig,
    ["{\"nrequired\":2,\"keys\":[\"032f061438c62aa9a1685d7451a4bf1af8d0b8c132b0db4614147df19b687c01db\",\"030dc96ba9b0dcce41a4b683164af15c045f0b169da1d1e234611a8cfc3195a143\"],\"network\":\"testnet\",\"addressType\":\"bech32\"}"],
  ...
  TestHelper.createBitcoinTestCase(
    ...
    CreateMultisig,
    ["{\"nrequired\":2,\"keys\":[\"02e9662b666479ed7117aa76fb96f322a84408d0882707b301c7450098d439680d\",\"03c0230a322f70675bef21097242ac70647798826588e47eca14e5715cef77008c\"],\"network\":\"mainnet\",\"addressType\":\"bech32\"}"],
  ...
  TestHelper.createBitcoinTestCase(
    ...
    CreateMultisig,
    ["{\"nrequired\":2,\"keys\":[\"0205ffcdde75f262d66ada3dd877c7471f8f8ee9ee24d917c3e18d01cee458bafe\",\"02be61f4350b4ae7544f99649a917f48ba16cf48c983ac1599774958d88ad17ec5\"],\"network\":\"regtest\",\"addressType\":\"bech32\"}"],
  ...
  TestHelper.createBitcoinTestCase(
    "CreateMultisig Mainnet(addressType legacy)",
    CreateMultisig,
    ["{\"nrequired\":2,\"keys\":[\"02e9662b666479ed7117aa76fb96f322a84408d0882707b301c7450098d439680d\",\"03c0230a322f70675bef21097242ac70647798826588e47eca14e5715cef77008c\"],\"network\":\"mainnet\",\"addressType\":\"legacy\"}"],
  ...
  TestHelper.createBitcoinTestCase(
    "CreateMultisig Mainnet(addressType p2sh-segwit)",
    CreateMultisig,
    ["{\"nrequired\":2,\"keys\":[\"02e9662b666479ed7117aa76fb96f322a84408d0882707b301c7450098d439680d\",\"03c0230a322f70675bef21097242ac70647798826588e47eca14e5715cef77008c\"],\"network\":\"mainnet\",\"addressType\":\"p2sh-segwit\"}"],
  ...
  TestHelper.createBitcoinTestCase(
    "CreateMultisig Regtest(addressType legacy)",
    CreateMultisig,
    ["{\"nrequired\":2,\"keys\":[\"03789ed0bb717d88f7d321a368d905e7430207ebbd82bd342cf11ae157a7ace5fd\",\"03dbc6764b8884a92e871274b87583e6d5c2a58819473e17e107ef3f6aa5a61626\"],\"network\":\"regtest\",\"addressType\":\"legacy\"}"],
  ...
  TestHelper.createBitcoinTestCase(
    "CreateMultisig Regtest(addressType p2sh-segwit)",
    CreateMultisig,
    ["{\"nrequired\":2,\"keys\":[\"03789ed0bb717d88f7d321a368d905e7430207ebbd82bd342cf11ae157a7ace5fd\",\"03dbc6764b8884a92e871274b87583e6d5c2a58819473e17e107ef3f6aa5a61626\"],\"network\":\"regtest\",\"addressType\":\"p2sh-segwit\"}"],
...
const errorCase = [
  TestHelper.createBitcoinTestCase(
    ...
    CreateMultisig,
    ["{\"nrequired\":2,\"keys\":[\"0205ffcdde75f262\",\"02be61f4350b4ae7\"],\"network\":\"testnet\",\"addressType\":\"bech32\"}"],
    "{\"error\":{\"code\":1,\"type\":\"illegal_argument\",\"message\":\"Invalid Pubkey data.\"}}"
  ),
  TestHelper.createBitcoinTestCase(
    "CreateMultisig Error(Wrong network type)",
    CreateMultisig,
    ["{\"nrequired\":2,\"keys\":[\"0205ffcdde75f262d66ada3dd877c7471f8f8ee9ee24d917c3e18d01cee458bafe\",\"02be61f4350b4ae7544f99649a917f48ba16cf48c983ac1599774958d88ad17ec5\"],\"network\":\"test\",\"addressType\":\"bech32\"}"],
  ...
  TestHelper.createBitcoinTestCase(
    ...
    "{\"error\":{\"code\":1,\"type\":\"illegal_argument\",\"message\":\"Invalid addressType. addressType must be \\\"legacy\\\" or \\\"bech32\\\".\"}}"
  ),
  TestHelper.createBitcoinTestCase(
    "CreateMultisig Error(require_num is over)",
    CreateMultisig,
    ["{\"nrequired\":2,\"keys\":[\"0205ffcdde75f262d66ada3dd877c7471f8f8ee9ee24d917c3e18d01cee458bafe\"],\"network\":\"testnet\",\"addressType\":\"bech32\"}"],
  ...
  TestHelper.createBitcoinTestCase(
    ...
    CreateMultisig,
    ["{\"nrequired\":2,\"keys\":[],\"network\":\"testnet\",\"addressType\":\"bech32\"}"],
  ...
  TestHelper.createBitcoinTestCase(
    ...
    CreateMultisig,
    ["{\"nrequired\":2,\"keys\":[\"abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrstuvwxyzabcdefghijklmn\",\"abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrstuvwxyzabcdefghijklmn\"],\"network\":\"testnet\",\"addressType\":\"bech32\"}"],
    "{\"error\":{\"code\":1,\"type\":\"illegal_argument\",\"message\":\"hex to byte convert error.\"}}"
  ),
  TestHelper.createBitcoinTestCase(
    "CreateMultisig Error(nrequired is 0)",
    CreateMultisig,
    ["{\"nrequired\":0,\"keys\":[\"02e9662b666479ed7117aa76fb96f322a84408d0882707b301c7450098d439680d\",\"03c0230a322f70675bef21097242ac70647798826588e47eca14e5715cef77008c\"],\"network\":\"mainnet\",\"addressType\":\"bech32\"}"],
    "{\"error\":{\"code\":1,\"type\":\"illegal_argument\",\"message\":\"CreateMultisigScript require_num is 0.\"}}"
  ),
  TestHelper.createBitcoinTestCase(
    "CreateMultisig Error(wrong nrequired)",
    CreateMultisig,
    ["{\"nrequired\":-1,\"keys\":[\"0205ffcdde75f262d66ada3dd877c7471f8f8ee9ee24d917c3e18d01cee458bafe\",\"02be61f4350b4ae7544f99649a917f48ba16cf48c983ac1599774958d88ad17ec5\"],\"network\":\"testnet\",\"addressType\":\"bech32\"}"],
