...
if (!supportFunctions.elements) {
  ...
  let Issuance_SetRawIssueAssetResult
  {
    console.log("\n===== SetRawIssueAsset =====")
    const paramJson = {
      "txHex": Issuance_CreateRawTransactionResult.hex,
      "isRandomize": false,
      "issuances": [{
  ...
  let Issuance_BlindRawTransactionResult
  {
    console.log("\n===== Issuance_BlindRawTransaction =====")
    const paramJson = {
      "txHex": Issuance_SetRawIssueAssetResult.hex,
      "txins": [{
        "txid": "7a8ee90c484cff3e1f7f8eed5acd6f4e6ad3e6ce4114d02a71f443e671d79925",
        "vout": 0,
        "asset": "186c7f955149a5274b39e24b6a50d1d6479f552f6522d91f3a97d771f1c18179",
      ...
      "blindPubkeys": [
        "03c9104d9ffbec46e25ea783ac1968800203888f287c735cbb5af3a4be250dc849",
        "03bcb46403c62f1d39ad824450145dc4e45c2772345686c22508cc370d38547fce",
        "02893fdde05b0f0d2662f75d63860ba5c5b02424a66e7a1f8d0a98dcd02bb74748"
      ],
      "issuances": [{
        "txid": "7a8ee90c484cff3e1f7f8eed5acd6f4e6ad3e6ce4114d02a71f443e671d79925",
        "vout": 0,
  ...
  let Issuance_UnblindRawTransactionResult
  {
    ...
    const paramJson = {
      "txHex": Issuance_BlindRawTransactionResult.hex,
      "blindingKeys": [
        "7c128a6ab09f148a73931b26ffe31caa882e8e3e4e285d164591c18f0a662f85",
        "edb7287b0a37ca61c8a6292918795fa49a396148080084ca0c8efb0fa82a98e7",
        "5bd8668f40929871af9cebb284a32daed8dbde61354dd1c8de4afbd0fe6b2eef"
      ],
      "issuances": [
        {
          "txid": "7a8ee90c484cff3e1f7f8eed5acd6f4e6ad3e6ce4114d02a71f443e671d79925",
  ...
  let masterBlindingKey = "ac2c1e4cce122139bb25abc50599e09738143cc4bc96e55f399a5e1e45d916a9"
  // elements-cli getnewaddress
  let address = [
    "AzpjqbZXsxNJHTXGUqs8NXaB6Gnc3GDQwPZyM5RsyKADgskLV2kNNbEvPYMKMoe3isE6KmMvpkZUeaBd", // utxo_change
    "CTEqDhneTZzhksSrhRdpRkK9FwLx4suzrhTG9uJHWCmDLsLNufchmhX4hzVDeuFmo8qWFwFMaC2rtCrL", // utxo_issuance
  ...
  let blindPubkeys = [
    "02200d8510dfcf8e2330c0795c771d1e6064daab2f274ac32a6e2708df9bfa893d", // utxo_change
    "02cc645552109331726c0ffadccab21620dd7a5a33260c6ac7bd1c78b98cb1e35a", // utxo_issuance
    "03ce4c4eac09fe317f365e45c00ffcf2e9639bc0fd792c10f72cdc173c4e5ed879"  // reissue
  ]
  // elements-cli dumpblindingkey "address"
  let blindingKeys = [
    "6a64f506be6e60b948987aa4d180d2ab05034a6a214146e06e28d4efe101d006", // utxo_change
    "94c85164605f589c4c572874f36b8301989c7fabfd44131297e95824d473681f", // utxo_issuance
  ...
  let Reissuance_CreateRawTransactionResult
  {
    ...
    const paramJson = {
      ...
      "txouts": [{
        "address": address[0],
        "amount": (utxo_change.amount - reissue_fee),
        "asset": utxo_change.asset
      },{
        "address": address[1],
        "amount": utxo_issuance.amount,
        "asset": utxo_issuance.asset
      }],
      "fee": {
        "amount": reissue_fee,
        "asset": utxo_change.asset
  ...
  let Reissuance_SetRawReissueAssetResult
  {
    console.log("\n===== SetRawReissueAsset =====")
    const paramJson = {
      "txHex":Reissuance_CreateRawTransactionResult.hex,
      "isRandomize": false,
      "issuances": [{
  ...
  let Reissuance_BlindRawTransactionResult
  {
    ...
    const paramJson = {
      "txHex": Reissuance_SetRawReissueAssetResult.hex,
      "txins": [{
        "txid": utxo_change.txid,
        "vout": utxo_change.vout,
        "asset": utxo_change.asset,
        "blindFactor": utxo_change.blindFactor,
        "assetBlindFactor": utxo_change.assetBlindFactor,
        "amount": utxo_change.amount
      },{
        "txid": utxo_issuance.txid,
        "vout": utxo_issuance.vout,
        "asset": utxo_issuance.asset,
        "blindFactor": utxo_issuance.blindFactor,
        "assetBlindFactor": utxo_issuance.assetBlindFactor,
        "amount": utxo_issuance.amount
      }],
  ...
  let Reissuance_UnblindRawTransactionResult
  {
    ...
    const paramJson = {
      "txHex":Reissuance_BlindRawTransactionResult.hex,
