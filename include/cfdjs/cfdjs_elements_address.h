 ...
 * JSON形式のAPIを提供する.
 */
#ifndef CFD_JS_INCLUDE_CFDJS_CFDJS_ELEMENTS_ADDRESS_H_
#define CFD_JS_INCLUDE_CFDJS_CFDJS_ELEMENTS_ADDRESS_H_
 ...
 */
class CFD_JS_EXPORT ElementsAddressStructApi {
 public:
  /**
...
#endif  // CFD_JS_INCLUDE_CFDJS_CFDJS_ELEMENTS_ADDRESS_H_
